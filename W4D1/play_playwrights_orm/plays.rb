...
class Play
  ...
  def self.find_by_playwright(name)
    play = PlayDBConnection.instance.execute("SELECT * FROM playwrights WHERE name = ?", name)
  end
...
class Playwright
  ...
  def self.find_by_name(name)
    playwright = PlayDBConnection.instance.execute("SELECT * FROM playwrights WHERE name = ?", name)
  ...
  def get_plays
    raise "playwright not in the database" unless self.id
